...
import com.sugon.sugonlive.model.NetState;
import com.sugon.sugonlive.model.Strings;
import com.sugon.sugonlive.util.NetStateUtil;
import com.sugon.sugonlive.util.ProgressTextView;
import com.sugon.sugonlive.util.Settings;
import com.sugon.sugonlive.util.PlayerVerticalSeekBar;
...
public class LivePlayerActivity extends BaseActivity implements View.OnClickListener {
    ...
    private PlayerVerticalSeekBar mAudioSeekbar;
...
//            KSYMediaMeta meta = KSYMediaMeta.parse(bundle);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAudioSeekbar = (PlayerVerticalSeekBar) findViewById(R.id.player_audio_seekbar);
        ...
        mVideoView = (KSYTextureView) findViewById(R.id.player_view);
        ...
        public void onNetStateChange(int netWorkState) {
            switch (netWorkState) {
                ...
                case NetState.NETWORK_NONE:
                    Toast.makeText(LivePlayerActivity.this, "没有监测到网络,请检查网络连接", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.player_screen: {
                ...
                savebitmap(bitmap);
                if (bitmap != null) {
                    Toast.makeText(LivePlayerActivity.this, "截图成功", Toast.LENGTH_SHORT).show();
                }
            }
            break;
            default:
    ...
    public void savebitmap(Bitmap bitmap) {
        File appDir = new File(Environment.getExternalStorageDirectory(), "com.sugon.sugonlive");
        if (!appDir.exists()) {
            appDir.mkdir();
        }
